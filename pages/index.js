      ...
      <div className={styles.profile}>
        ...
        <div className={styles.profileRight}>
          <Tabs defaultActiveKey="1" centered>
            ...
            <TabPane tab="Follow Me" key="2">
              <div className={styles.followMe}>
                ...
                <div className={styles.promptTwo}>
                  Give me a follow and receive this NFT!
                </div>
            ...
            <TabPane tab="Social Posts" key="3" disabled={false} />
            
            <TabPane tab="DAO" key="4" disabled={false} />

            <TabPane tab="Campaigns" key="5" disabled={false} />

            <TabPane tab="Wallet" key="6" disabled={true} />
          </Tabs>
        </div>
      </div>
    </div>
